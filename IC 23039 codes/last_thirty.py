...
for key,df in frames.items():
    for yr in yrlist:
        ...
        for _,row in df[(df['year'] == yr)].iterrows():
            ...
            if row['beh_type'] == 6:
                score += 6
            if row['beh_handheld'] == 1: 
                score += 10
            if row['beh_handheld'] == 2:
                score += 9
            if row['beh_handheld'] == 3:
                score += 7
            if row['beh_handheld'] == 4:
                score += 4
            if row['beh_handheld'] == 6:
                score += 6
            if row['beh_handfree'] == 1: 
                score += 10
            if row['beh_handfree'] == 2:
                score += 9
            if row['beh_handfree'] == 3:
                score += 7
            if row['beh_handfree'] == 4:
                score += 4
            if row['beh_handfree'] == 6:
                score += 6
            if row['beh_app'] == 1: 
                score += 10
            if row['beh_app'] == 2:
...
fig = go.Figure()
fig = px.line(ndf, x="Year", y="Score", color='Age Group', title='"Last 30 Days" Questions Scores by Age Group')
